...
| ---------------------------- | ---------------------------------------------------------------------- | ----- |
| `01_schema_and_security.sql` | Types INT8, absence de bpchar, BRIN, SECURITY DEFINER, RBAC, triggers  | 35    |
| `02_identity_logic.sql`      | `create_account`, slugs, bitmask `has_permission`, `record_login`      | 9     |
